...
/**
 Dictionary of custom macro parameters to "pass-thru" when making the ad request.
 */
+ (void)setCustomMacros:(NSDictionary *)customMacros;

/**
 Dictionary of Key-Value pairs to "pass-thru" when making the ad request.
 These can be [key, value] or [key, array-of-values]
 */
